...
export const tutorialSteps = [
  ...
  { title: 'Keep every payment together', image: 'overview', text: 'Overview shows the shared Kitty and your balance. Tap Add expense whenever you pay. Invite friends by sharing the PIN under Travelers · Invite friends.', target: 'Tap Add expense to record a payment', box: [26, 79, 44, 10] },
  { title: 'Choose who shares the cost', image: 'expense', text: 'Use Personal Pocket for money you paid. Enter the amount and description, then choose the people who shared it. Only me keeps an expense private. Check the split before saving.', target: 'Choose everyone who shared this expense', box: [4, 33, 88, 35] },
  { title: 'One Kitty for shared spending', image: 'kitty', text: 'Choose Kitty, then Add my contribution to record money you put into the group fund. Everyone can contribute and view history; only the lead can record Kitty spending.', target: 'Switch to Kitty and choose a contribution', box: [4, 21, 88, 25] },
  { title: 'Know who owes whom', image: 'settlement', text: 'Open Settlement for the amounts to pay or receive. Personal Pocket and Group Kitty are separate. TripRoam calculates balances; it does not transfer money. Check that entries say Synced before settling.', target: 'Check both settlement tabs', box: [4, 22, 88, 9] },
